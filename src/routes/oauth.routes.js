...
// Railway routes outbound HTTPS through a proxy with a self-signed cert.
// Disable cert verification for the Monday OAuth token exchange only.
const _mondayAgent = new https.Agent({ rejectUnauthorized: false });
